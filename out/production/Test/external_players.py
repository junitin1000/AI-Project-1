...
# TODO add boolean for pass vs go, if pass add pass_time of 2 and use pass files
# pass_or_go: if true, pass, else, go
def external_player(board, name, opponent_name, pass_or_go=False, time_limit=10):
    # def external_player(board, main_board, local_board_num, my_symbol, opponent_symbol, name, opponent_name,
    #                     time_limit):
